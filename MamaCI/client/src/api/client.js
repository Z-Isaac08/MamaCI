...
export const USE_MOCK = false; // Désactivation des mocks pour utiliser le vrai backend
const BASE_URL = 'http://192.168.68.171:3000'; // Configuration sur l'IP Wi-Fi de votre PC
// -----------------------------------------------------------------------
...
function normalizeError(error) {
  ...
  if (error.code === 'ECONNABORTED') {
    return { code: 'TIMEOUT', message: "La connexion met trop de temps à répondre." };
  }
  return { code: 'NETWORK_ERROR', message: "Impossible de joindre le serveur pour le moment." };
}
